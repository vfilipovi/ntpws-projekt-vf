...
$sql = "SELECT id, naslov, tekst,vrijemeObjave,kategorija,kratkiOpis,slikaPath FROM vijesti WHERE kategorija = 'scitech' ORDER BY vrijemeObjave DESC LIMIT 30";
$result = mysqli_query($conn, $sql);

print'<h2 class="naslovCentar">Sci/Tech</h2>';
